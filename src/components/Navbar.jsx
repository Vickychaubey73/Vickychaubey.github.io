    ...
    return (
        <nav
            className={`fixed w-full top-0 z-50 transition-all duration-500 ${
                isOpen || scrolled
                    ? "bg-[#0b0313]/80 backdrop-blur-md  border-purple-500/10"
                    : "bg-transparent"
            }`}
        >
                ...
                <div className="flex items-center justify-between h-16">
                        ...
                        <div className="ml-8 flex items-center space-x-8">
                            {navItems.map((item) => (
                                <a
                                    ...
                                    className="group relative px-1 py-1 text-sm font-medium"
                                >
                                    <span
                    ...
                    <div className="md:hidden">
                        <button
                            ...
                            className={`p-2 text-[#e2d3fd] hover:text-white transition-all duration-300 ease-in-out transform ${
